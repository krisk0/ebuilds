...
#                2018 Haelwenn (lanodan) Monnier (https://hacktivis.me)
#                2018 Крыськов Денис
...
inherit check-reqs chromium-2 eutils gnome2-utils flag-o-matic multilib ninja-utils\
    pax-utils portability python-any-r1 readme.gentoo-r1 toolchain-funcs versionator\
    xdg-utils

DESCRIPTION="privacy-focused modification of the Chromium web browser"
HOMEPAGE="https://iridiumbrowser.de/"
SRC_URI="https://downloads.iridiumbrowser.de/source/$P.tar.xz"
...
src_configure() {
	...
	set -- /usr/bin/gn gen --args="${myconf_gn} ${EXTRA_GN}" out/Release
	echo "$@"
	"$@" || die
}
